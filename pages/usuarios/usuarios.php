...
<head>
  ...
  <title>Usuarios Taqueria Mario's</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <button class="btn btn-primary mb-3" id="btnRegistroUsuario">Registrar usuario</button>
          <!-- /.row -->
          <div class="row">
            <div class="col-12">
              <div class="card">
      ...
      <div class="modal fade" id="modal-editar">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="usuarioId"></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="" method="post">
                <input type="hidden" name="input_usuario_id" id="input_usuario_id">
                <div class="w-50">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
              <button type="button" class="btn btn-primary swalDefaultSuccess" id="actualizarUsuario" data-dismiss="modal">Actualizar cambios</button>
